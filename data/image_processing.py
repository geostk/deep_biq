...
def distorted_inputs(dataset, batch_size=None, num_preprocess_threads=None):
    ...
    tf.summary.image('train_images', images, max_outputs=16)
    return images, labels
...
def parse_example_proto(example_serialized):
    ...
    # print(features['image/class/text'].eval(),features['image/filename'])
...
def gen_no_overlapping_boxes(org_width, org_height, target_width, target_height, num=30):
    ...
    boxes = []
    for width in width_offsets:
        for height in height_offsets:
            boxes.append([width, height, target_height, target_width])
