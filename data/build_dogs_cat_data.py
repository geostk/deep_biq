...
tf.app.flags.DEFINE_string('train_directory',
                           '/Users/andy/Downloads/train',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory',
                           '/Users/andy/Downloads/test',
...
tf.app.flags.DEFINE_integer('num_threads', 24,
...
if not os.path.exists(FLAGS.output_directory): os.mkdir(FLAGS.output_directory)
